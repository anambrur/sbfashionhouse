        ...
        <div class="container" id="columns">
            ...
            <div class="row">
                ...
                <div class="column col-xs-12 col-sm-3" id="left_column">
                                    ...
                                    <ul class="blog-list-sidebar clearfix">
                                        <li>
                                            <div class="post-thumb">
                                                <a href="#"><img src="{{ asset('frontend/') }}/images/news/news1.png" class="image-style" alt="Blog"></a>
                                            </div>
                                            <div class="post-info">
                                        ...
                                        <li>
                                            <div class="post-thumb">
                                                <a href="#"><img src="{{ asset('frontend/') }}/images/news/news2.png" class="image-style"  alt="Blog"></a>
                                            </div>
                                            <div class="post-info">
                                                <h5 class="entry_title"><a href="#">Lorem ipsum dolor sit amet</a></h5>
                                                <div class="post-meta">
                                        ...
                                        <li>
                                            <div class="post-thumb">
                                                <a href="#"><img src="{{ asset('frontend/') }}/images/news/news3.png" class="image-style"  alt="Blog"></a>
                                            </div>
                                            <div class="post-info">
                                                <h5 class="entry_title"><a href="#">Lorem ipsum dolor sit amet</a></h5>
                                                <div class="post-meta">
                    ...
                    <div class="block left-module">
                        <div class="banner-opacity">
                            <a href="#"><img src="{{ asset('frontend/') }}/images/news/news5.png" alt="ads-banner"></a>
                        </div>
                    </div>
                    <!-- ./Banner -->
                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="entry-thumb image-hover2">
                                            <a href="#">
                                                <img src="{{ asset('frontend/') }}/images/news/news1.png" alt="Blog">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
                                        <div class="entry-ci">
                                            ...
                                            <div class="entry-more">
                                                <a href="newsdetails.php">Read more</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <article class="entry">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="entry-thumb image-hover2">
                                            <a href="#">
                                                <img src="{{ asset('frontend/') }}/images/news/news2.png" alt="Blog">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
                            ...
                            <article class="entry">
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="entry-thumb image-hover2">
                                            <a href="#">
                                                <img src="{{ asset('frontend/') }}/images/news/news3.png" alt="Blog">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-sm-7">
