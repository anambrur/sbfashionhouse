...
class HomeController extends Controller
{
    ...
    public function homePageData()
    {
        ...
        // $data["categoriesWithSubcategories"] = $this->buildCategoryHierarchy(0);
        // dd($data["categoriesWithSubcategories"]);
    ...
    function buildCategoryHierarchy($parentId = 0)
    {
        ...
        foreach ($categories as $category) {
            $subcategories = $this->buildCategoryHierarchy($category->id);
